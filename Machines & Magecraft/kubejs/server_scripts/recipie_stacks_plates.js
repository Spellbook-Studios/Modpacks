...
function replaceList(event, toReplaceList, replaceWith, outputs) {
  for(var j = 0; j < toReplaceList.length; j++) {
    let toReplace = toReplaceList[j]
...
ServerEvents.recipes(event => { //listen for the "recipes" server event.
  ...
  replaceList(event, ['minecraft:copper_ingot','#forge:ingots/copper'], '#forge:plates/copper', ['mekanismgenerators:heat_generator',
